package exemploClasseArreyList;
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    for (Pessoa contato : pessoas) {
                        JOptionPane.showMessageDialog(null, i + " - Nome: " + contato.getNome() + " - CPF: " + contato.getCpf() + " - Idade: " + contato.getIdade(), "Pessoas", JOptionPane.DEFAULT_OPTION);
                        i++;
                    }
                    break;
                case 3:
